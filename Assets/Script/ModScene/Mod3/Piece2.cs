...
public class Piece2 : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        if (isSelect)
        {
            ...
            Pic.color = new Color(0, 0.5f, 0, 1);
            mod3_Mgr.Clear_Cnt++;
        }
        else
        {
            transform.localPosition = new Vector3(-250, -410, 0);
